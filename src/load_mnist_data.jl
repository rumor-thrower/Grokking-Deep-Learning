...
"""
    transform_data(
        images::Array{R, 3},
        labels::Vector{Int64}
    )::Tuple{Matrix{R}, SparseMatrixCSC{Bool, Int64}} where R <: Real
...
function transform_data(
    images::Array{R, 3},
    labels::L
)::Tuple{Matrix{R}, SparseMatrixCSC{Bool, Int64}} where {R <: Real, L <: AbstractVector{Int64}}
	flattened_images::Matrix{R} = flatten_images(images)
